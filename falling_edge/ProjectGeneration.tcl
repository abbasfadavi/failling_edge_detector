...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set ProjectFiles {
		...
		{{falling_detector_entity_declarations.vhd} -lib {xil_defaultlib}}
		{{falling_detector.vhd} -lib {xil_defaultlib}}
		{{falling_detector_clock.xdc}}
		{{falling_detector.xdc}}
	}
	set SimPeriod 1e-08
	set SimTime 0.0011
	...
	set TopLevelModule {falling_detector}
	...
	dict set TopLevelPortInterface in_x0 DatFile {falling_detector_in.dat}
	...
	dict set TopLevelPortInterface in_x0 ClockDomain {falling_detector}
	...
	dict set TopLevelPortInterface out_x0 DatFile {falling_detector_out.dat}
	...
	dict set TopLevelPortInterface out_x0 ClockDomain {falling_detector}
	...
	dict set TopLevelPortInterface clk ClockDomain {falling_detector}
